...
%dimReductionConfig setup:
ex.bin.dimReductionConfig.units=
ex.bin.dimReductionConfig.windows=%trialStartEnd
ex.bin.dimReductionConfig.dimension=8
ex.bin.dimReductionConfig.segLength=40
ex.bin.dimReductionConfig.trials=%nonbumpTrials.number
